...
const BLOG = {
  ...
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID || 'cc565572363a43a58dbc6bbd09b47b4b',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'HackNerd', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'Hi, 欢迎来到我的博客🎉', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS:
    process.env.NEXT_PUBLIC_KEYWORD ||
    'Notion, 博客, Front-end, web, html, css, Javascript, React, Vue, Node js, Typescript, Docker, Electron, Game, Earning, Book, Movie...', // 网站关键词 英文逗号隔开
  ...
  CONTACT_GITHUB:
    process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/HackNerd1', // 你的github个人主页 例如 https://github.com/tangly1024
