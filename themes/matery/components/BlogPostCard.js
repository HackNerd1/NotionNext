  ...
  return (
    ...
    >
      <div
        ...
        className="h-80 w-full group cursor-pointer relative mb-4 overflow-hidden shadow-md border dark:border-black rounded-xl bg-white dark:bg-hexo-black-gray"
      >
        <LazyImage
        ...
        <div className="absolute bottom-0 w-full">
          <div className="text-white p-6 text-2xl replace break-words shadow-text">
            {post.title}
          </div>
          {/* 文字描述 */}
          <div className="bg-white/0 w-full  backdrop-blur-lg">
            {/* 描述 */}
            <div className="px-4 flex flex-col w-full text-white dark:text-gray-300">
              ...
              <div className="text-white justify-between flex my-2  dark:text-gray-300">
                <div>
                  <Link
                ...
                <Link
                  ...
                  passHref
                  className="cursor-pointer font-light text-sm hover:underline hover:text-indigo-200 dark:hover:text-indigo-400 transform"
                >
